...
class PluginLoaderService {
  ...
  Future<void> addPlugin(String sourcePath) async {
    ...
    if (source.existsSync()) {
      ...
      throw Exception('File-based plugin installation not yet implemented. Please provide a directory path.');
  ...
  bool isPluginLoaded(String pluginId) {
    return pluginManager.loadedPlugins.any((plugin) => plugin.pluginId == pluginId);
  }
  ...
  void _validateSettings(PluginManifest manifest, Map<String, dynamic> settings) {
