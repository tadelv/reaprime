  ...
  Future<int> _importSettings(
    ...
    if (settings != null) {
      if (settings.containsKey('gatewayMode')) {
        final mode = GatewayModeFromString.fromString(settings['gatewayMode']);
        if (mode != null) {
      ...
      if (settings.containsKey('blockOnNoScale')) {
        await _controller.setBlockOnNoScale(settings['blockOnNoScale'] as bool);
        imported++;
      }
      ...
      if (settings.containsKey('defaultSkinId')) {
        await _controller.setDefaultSkinId(settings['defaultSkinId'] as String);
        imported++;
      }
